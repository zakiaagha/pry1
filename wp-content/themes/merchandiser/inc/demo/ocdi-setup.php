...
function ocdi_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/demo/merchandiser.default.xml',
    ),
  );
}
...
function ocdi_plugin_page_setup( $default_settings ) {
  ...
  $default_settings['page_title']  = esc_html__( 'One Click Demo Import' , 'merchandiser' );
  $default_settings['menu_title']  = esc_html__( 'Import Demo Data' , 'merchandiser' );
